...
namespace Csg.Data
{
    public static class DbQueryBuilderExtensions
    {
        ...
        public static IDbQueryWhereClause AddFilter(this Csg.Data.IDbQueryWhereClause where, ListQueryFilter filter, System.Data.DbType valueType, int? valueTypeSize = null, SqlWildcardDecoration stringMatchType = SqlWildcardDecoration.BeginsWith, bool performDataTypeConversion = true, Func<object, object> valueConverter = null)
        {
